...
public class UserRequestsAdapter extends ArrayAdapter<Request> {

    private LayoutInflater mInflater;
    List<Request> requests;
    public UserRequestsAdapter(Context context, int resource, int textViewResourceId, List<Request> objects) {
